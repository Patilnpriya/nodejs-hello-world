...
variable "service_name" {
  type        = list
  description = "The name of the ECS Service in the ECS cluster to monitor"
  default     = ["product-inventory-mgmt-int","or-kci-notification","mop-service-order-int","service-order-integrator","ccta-crm-event-mgmt-int","resource-inventory-integrator","customer-management-integrator","service-inventory-integrator","party-mgmt-int"]
  #default     = ["supply-chain-int"]
}
...
variable "queue_name" {
  ...
  #default = "ccta-crm-event-mgmt-int_DLQ"
  default = ["ccta-ORKCIToBP_DLQ","ccta-PrdInvtyMgmtToServiceNow_DLQ","ccta-PrdInvtyToNetcracker_DLQ","ccta-PrdInvtyToServiceNow_DLQ","ccta-PrtyMgmtToServiceNow_DLQ","ccta-SvcInvToServiceNow_DLQ","ccta-SvcInvToVlocity_DLQ","ccta-crm-event-mgmt-int_DLQ","ccta-mop-service-order-to-vlocity_DLQ","kano-RrcInvToServiceNow_DLQ","kano-SfdcEventsToServiceNow_DLQ","kano-SvcInvToServiceNow_DLQ"]
}
#====== Metric Type======================================================================
variable "metric_5x" {
  type        = string
