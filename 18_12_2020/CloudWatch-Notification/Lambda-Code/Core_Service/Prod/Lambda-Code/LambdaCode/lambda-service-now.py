...
def lambda_handler(event, context):
   ...
   # Sending Email Notification through SNS
    ...
    MY_SNS_TOPIC_ARN = 'arn:aws:sns:eu-west-2:695171761367:App15549_Simplify-Core-Services_ECS-Prod_DevOps_Notification_Topic'
    ...
    if(service_type == "QueueName"):
        ...
        TopicArn = MY_SNS_TOPIC_ARN,
        Subject = str(subject),
        Message =  ' The ECS Fargate ' + service_name.upper() +' Service '+ alarm_state +' '+ str(metric_name)+ ' Threshold Value !!' +'\n' +
                  '\n Alarm Name: ' +str(alarm) +'\n'+
				  'Message_ID: ' +str(messageid) +'\n'+
				  'Topic_Arn: ' +str(topic_arn) +'\n'+
				  'AWS_ACCOUNT_ID: ' +str(awsid) +'\n'+
