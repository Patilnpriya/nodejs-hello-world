...
def lambda_handler(event, context):
    ...
    RO_user = 'bt_purple_integration_user_beta'
   ...
   # Sending Email Notification through SNS
    ...
    MY_SNS_TOPIC_ARN = 'arn:aws:sns:eu-west-2:408717978921:App15529_Ciena-Service-Order-Fulfilment_EC2_Beta_DevOps_Mail_Topic'
