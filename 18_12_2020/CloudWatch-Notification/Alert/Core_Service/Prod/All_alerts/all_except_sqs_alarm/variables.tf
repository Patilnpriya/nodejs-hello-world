...
variable "cluster_name" {
  ...
  #Dev & Test Cluster Name
  #default = "kano-coreservices-cluster"
  #Beta & Prod Cluster Name
...
variable "service_name" {
  ...
  #Dev --- Services ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  #default     = ["service-order-integrator","resource-inventory-integrator","customer-management-integrator","service-inventory-integrator","party-mgmt-int","ccta-crm-event-mgmt-int"]
  #----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
